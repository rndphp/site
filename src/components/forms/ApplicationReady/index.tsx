...
const ApplicationReady: React.FC<IProps> = ({ handler }) => {
    ...
    return (
        <div className={cn.wrapper}>
            <form className={cn.form} onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className={cn.input}>
                    <Input
                        isError={!!errors.abstracts}
                        errorText={errorTextAbstracts}
                        isTextarea
                        label="Тезисы (публичные) *"
                        {...register('abstracts', {
                            required: 'Заполните поле Тезисы',
                        })}
                    />
                </div>
                <div className={cn.input}>
                    <Input
                        isTextarea
                        label="Описание доклада (для докладчика)"
                        {...register('description')}
                    />
                </div>
                <div className={cn.input}>
                    <Input type="text" label="Ссылка на презентацию" {...register('link')} />
                </div>
